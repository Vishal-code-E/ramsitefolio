          ...
          <div className="max-w-3xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              <a
                ...
                className="group relative inline-flex items-center gap-3 px-8 py-4 bg-white text-black hover:bg-gray-100 font-semibold rounded-full transition-all duration-300 transform hover:scale-105 hover:shadow-[0_0_30px_rgba(255,255,255,0.2)]"
              >
                <span>Subscribe on Hashnode</span>
                <Send className="w-5 h-5 group-hover:translate-x-1 transition-transform" />
              </a>
            </div>
            <p className="text-xs text-gray-500 mt-4">
              Join the newsletter to get notified when I publish new content.
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-gray-400 mb-6 max-w-md leading-relaxed">
              Full Stack Developer & AI Entrepreneur specializing in Agentic AI, Machine Learning, 
              and autonomous systems. Building cutting-edge solutions that empower startups and creators.
            </p>
            <div className="flex space-x-4">
              <a 
                ...
                target="_blank" 
                rel="noopener noreferrer" 
                className="group relative p-3 bg-gray-800/50 hover:bg-gray-700 rounded-lg transition-all duration-300 hover:scale-110" 
                aria-label="GitHub"
              >
              ...
              <a 
                href="mailto:sriram182719@gmail.com" 
                className="group relative p-3 bg-gray-800/50 hover:bg-gray-700 rounded-lg transition-all duration-300 hover:scale-110" 
                aria-label="Email"
              >
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
            ...
            <ul className="space-y-3">
              <li>
                <button 
                  ...
                  className="text-gray-400 hover:text-white transition-colors text-left bg-transparent border-0 p-0 cursor-pointer hover:translate-x-1 inline-block duration-200"
                >
                  About
                </button>
              </li>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-gray-500 text-sm">
              © {currentYear} Sri Ram. Crafted with passion and code.
            </p>
            <div className="flex flex-wrap gap-6 justify-center">
              ...
              <button 
                onClick={() => scrollToSection('#contact')} 
                className="text-gray-500 hover:text-white text-sm transition-colors bg-transparent border-0 p-0 cursor-pointer"
              >
                Get in Touch
              </button>
            </div>
